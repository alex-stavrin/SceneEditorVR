...
public class ToolsManager : MonoBehaviour
{
    ...
    void Start()
    {
        translationAmountText.SetText("Move Snap: " + PlayerPreferencesManager.Instance.snappingTranslationAmount.ToString("F1"));
        rotationAmountText.SetText("Rotate Snap: " + PlayerPreferencesManager.Instance.snappingRotationAmount.ToString("F1"));   
        scaleAmountText.SetText("Scale Snap: " + PlayerPreferencesManager.Instance.snappingScaleAmount.ToString("F1"));          
    }
    ...
    public void AddTranslationSnappingAmount()
    {
        ...
        translationAmountText.SetText("Move Snap: " + res.ToString("F1"));
    }
    ...
    public void AddRotationSnappingAmount()
    {
        ...
        rotationAmountText.SetText("Rotate Snap: " + res.ToString("F1"));
    }
    ...
    public void AddScaleSnappingAmount()
    {
        ...
        scaleAmountText.SetText("Scale Snap: " + res.ToString("F1"));
    }
